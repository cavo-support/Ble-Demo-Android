...
public class FunctionActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        Function defaultFunction = new Function(DefaultFunctionActivity.FUNCTION_ID, getString(R.string.app_default_function));
            ...
            public void onItemClick(int pos) {
                switch (pos) {
                    ...
                    case HRVRmssdActivity.FUNCTION_ID:
                        ...
                        break;
                    case DefaultFunctionActivity.FUNCTION_ID:
                        startActivity(new Intent(FunctionActivity.this, DefaultFunctionActivity.class));
                        break;
                }
            }
        });
